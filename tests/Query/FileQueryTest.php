...
class FileQueryTest extends TestCase
{
    public function testValidFileQuery(): void
    {
        $testFileQueryPaths = [
            ...
            '(./path/to/file.xml, windows-1250)' => null,
            '(./path/to/file.csv)' => null,
            '(./path/to/file.csv, utf-8)' => '(./path/to/file.csv)',
            '(./path/to/file.csv, utf-8, ",")' => '(./path/to/file.csv)',
            '(./path/to/file.csv, utf-8, ";")' => null,
            '(./path/to/file.csv, windows-1250, ";")' => null,
            '(./path/to/file.yaml)' => null,
            '(./path/to/file.neon)' => null,
            '(./path/to/file).*' => null,
            '(./path/to/file).SHOP' => null,
            '(./path/to/file).SHOP.SHOPITEM' => null,
            '(./path/to/file, utf-8).SHOP.SHOPITEM' => '(./path/to/file).SHOP.SHOPITEM',
